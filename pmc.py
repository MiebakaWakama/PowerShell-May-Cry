...
#a normalized output
#testfile path C:\\Users\\Miebaka\\Documents\\Engagements\\Nike\\Powershell_obfuscation\\testscript.ps1
#******************************************************************************************************\
...
#Test commands
#inob("/mnt/hgfs/Nike/Powershell_obfuscation/testscript.ps1", "Token\\String\\1")
...
def report(methodlist,scriptname,tvalue):
    csvfile = open(f"C:\\Users\\Miebaka\\Documents\\Engagements\\Nike\\Powershell_obfuscation\\powershell_may_cry_report{tvalue}.csv",'a')
...
def exec_pmy(pcombs,tvalue,methods):
    ...
    scripts_dir = os.listdir("C:\\Users\\Miebaka\\Documents\\Engagements\\Nike\\Powershell_obfuscation\\Scripts")
    ...
    for n in combs:
        for x in scripts_dir:
            ffile = powershell_may_cry(n,f"C:\\Users\\Miebaka\\Documents\\Engagements\\Nike\\Powershell_obfuscation\\Scripts\\{x}",tvalue)
